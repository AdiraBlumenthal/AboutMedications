//
//  CriticalAtorvastatinInteractionsView.swift
//  AboutMedications
//
...
struct CriticalAtorvastatinInteractionsView: View {
...
//                VideoPlayer(player: AVPlayer(url:  Bundle.main.url(forResource: "diabeteVid_HotFix", withExtension: "mp4")!))
                Text("video with captions (critical interaction) doesn't exist yet!!")
...
//                VideoPlayer(player: AVPlayer(url:  Bundle.main.url(forResource: "Diabetes Info", withExtension: "MOV")!))
                    Text("ASL only video (critical interaction) doesn't exist yet!!")
...
struct CriticalAtorvastatinInteractionsView_Previews: PreviewProvider {
    static var previews: some View {
        CriticalAtorvastatinInteractionsView()
    }
}
