//
//  CriticalMetforminInteractionsView.swift
//  AboutMedications
//
...
struct CriticalMetforminInteractionsView: View {
    ...
    var body: some View {
        NavigationView{
            if ASLwithCaptions{
                ...
                Text("Interactions information (critical) video with captions -- does not exist yet!")
                
            } else if ASL{
                //            VideoPlayer(player: AVPlayer(url:  Bundle.main.url(forResource: "Metformin Purpose", withExtension: "MOV")!))
                Text("Interactions information (critical) video -- does not exist yet!")
            } else{
...
struct CriticalMetforminInteractionsView_Previews: PreviewProvider {
    static var previews: some View {
        CriticalMetforminInteractionsView()
    }
}
