//
//  ModerateAtorvastatinInteractionView.swift
//  AboutMedications
//
...
struct ModerateAtorvastatinInteractionView: View {
...
//                VideoPlayer(player: AVPlayer(url:  Bundle.main.url(forResource: "diabeteVid_HotFix", withExtension: "mp4")!))
                Text("video with captions (moderate interaction) doesn't exist yet!!")
...
//                VideoPlayer(player: AVPlayer(url:  Bundle.main.url(forResource: "Diabetes Info", withExtension: "MOV")!))
                    Text("ASL only video (moderate interaction) doesn't exist yet!!")
...
struct ModerateAtorvastatinInteractionView_Previews: PreviewProvider {
    static var previews: some View {
        ModerateAtorvastatinInteractionView()
    }
}
