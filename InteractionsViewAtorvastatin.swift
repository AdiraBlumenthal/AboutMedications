//
//  InteractionsViewAtorvastatin.swift
//  AboutMedications
//
...
struct InteractionsViewAtorvastatin: View {
...
struct InteractionsViewAtorvastatin_Previews: PreviewProvider {
    static var previews: some View {
        InteractionsViewAtorvastatin()
    }
}
